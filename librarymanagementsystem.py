...
6.exit""")
    ...
    if ch==1:
        ...
        print('{:<10}{:<20}{:<20}{:<20}{:<10}'.format('lib_id','book_name','author_name','stock','price'))
        print('-'*80)
        for lib in library:
            print('{:<10}{:<20}{:<20}{:<20}{:<10}'.format(lib['lib_id'],lib['book_name'],lib['author_name'],lib['stock'],lib['price']))
    elif ch==3:
        ...
        if search.isdigit():#digit aanonn check chyn
            search=int(search)#convert to int
        f=0
        for lib in library:
